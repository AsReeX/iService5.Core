...
// Type: iService5.Core.ViewModels.LegalInfoForLibViewModel
...
public class LegalInfoForLibViewModel : MvxViewModel
{
  private readonly IMvxNavigationService _navigationService;
  private string _NavText = AppResource.APPLIANCE_FLASH_BACK_TEXT;
  private string _NavHeaderTitle = AppResource.USED_LIBRARIES_HEADER;
  private string _AppVersionLabel;

  public LegalInfoForLibViewModel(
  ...
  public ICommand GoToLoginPage { internal set; get; }
