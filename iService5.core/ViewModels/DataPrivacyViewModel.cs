...
// Type: iService5.Core.ViewModels.DataPrivacyViewModel
...
public class DataPrivacyViewModel : MvxViewModel
{
  private readonly IMvxNavigationService _navigationService;
  private string _NavText = AppResource.APPLIANCE_FLASH_BACK_TEXT;
  private string _NavHeaderTitle = AppResource.DATA_PRIVACY_POLICY_TEXT;
  private string _AppVersionLabel;

  public DataPrivacyViewModel(IMvxNavigationService navigationService, IVersionReport versionReport)
  {
