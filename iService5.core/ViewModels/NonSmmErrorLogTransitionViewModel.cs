...
// Type: iService5.Core.ViewModels.NonSmmErrorLogTransitionViewModel
...
public class NonSmmErrorLogTransitionViewModel : MvxViewModel
{
  ...
  private string _CollectingMemoryLogLabel = AppResource.MEMORY_TRANSITION_PAGE_COLLECTING;

  public virtual async Task Initialize() => await base.Initialize();

  public NonSmmErrorLogTransitionViewModel(
  ...
  public string CollectingMemoryLogLabel
  {
    get => this._CollectingMemoryLogLabel;
    internal set
    {
      this._CollectingMemoryLogLabel = value;
      this.RaisePropertyChanged<string>((Expression<Func<string>>) (() => this.CollectingMemoryLogLabel));
    }
  }
  ...
  public override void ViewAppeared()
  {
    ...
    Task.Factory.StartNew((Action) (() =>
    {
      ...
      this._navigationService.Navigate<NonSmmErrorLogViewModel, SshResponse<object>>(this._sshWrapper.GetMemoryLog(), (IMvxBundle) null, new CancellationToken());
