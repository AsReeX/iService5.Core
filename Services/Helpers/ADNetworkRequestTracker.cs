...
public class ADNetworkRequestTracker
{
  ...
  {
    if (ADNetworkRequestTracker.tracker == null)
      return;
    ADNetworkRequestTracker.tracker.Exception = ex;
    ADNetworkRequestTracker.tracker.ReportDone();
  }
  ...
  public void ADTrackResponse(int statusCode)
  {
    if (ADNetworkRequestTracker.tracker == null)
      return;
    ADNetworkRequestTracker.tracker.ResponseCode = statusCode;
    ADNetworkRequestTracker.tracker.ReportDone();
  }
}
